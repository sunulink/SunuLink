  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <main className="pb-20">
        ...
        {/* MOTS DU FONDATEUR                                        */}
        {/* ========================================================= */}
        <section className="py-12 md:py-20 px-4 sm:px-6 bg-slate-50 border-y border-slate-200">
          <div className="container mx-auto max-w-7xl">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-center mb-10 md:mb-14 tracking-tight text-sunuBlue">
              Mots du <span className="text-sunuOrange">Fondateur</span>
            </h2>

            <div className="grid grid-cols-1 lg:grid-cols-[360px_minmax(0,1fr)] gap-8 lg:gap-12 items-start bg-white rounded-[2rem] border border-slate-200 shadow-xl overflow-hidden">
              {/* Profil fondateur */}
              <div className="relative lg:sticky lg:top-28 bg-gradient-to-br from-sunuBlue via-sunuBlue to-sunuCyan p-6 sm:p-8 lg:p-10 text-white h-full">
              ...
              <div className="p-5 sm:p-8 md:p-10 lg:p-12">
                ...
                >
                  ...
                  <div className="my-8 p-5 sm:p-7 md:p-8 bg-slate-50 rounded-2xl border-2 border-sunuBlue/20 text-gray-800 space-y-5">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      ...
                      <div className="hidden md:block h-px flex-1 bg-sunuBlue/15 ml-5" />
                    </div>
                  ...
                  <blockquote className="bg-blue-50/60 p-4 sm:p-5 rounded-xl border-l-4 border-sunuBlue italic my-4 text-sunuBlue font-medium text-left">
                  ...
                  <div className="pt-7 sm:pt-9 border-t border-slate-200 text-left sm:text-center space-y-3">
