      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div className="overflow-hidden">
                    <h4 className="font-bold mb-1 text-base sm:text-lg">{info.title}</h4>
                    <p className="opacity-90 text-sm sm:text-base break-words">{info.value}</p>
                  </div>
                </a>
              ))}
            </div>
            ...
            {/* Social Links */}
            <div className="grain-texture bg-gradient-to-br from-sunuOrange to-yellow-500 rounded-xl md:rounded-2xl p-4 sm:p-6 text-white" data-aos="fade-right" data-aos-delay="400">
              <h4 className="font-bold mb-3 md:mb-4 text-base sm:text-lg">Suivez-nous sur les réseaux sociaux</h4>
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <a
                  href="https://www.facebook.com/share/19oMyxQApw/?mibextid=LQQJ4d"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/20 hover:bg-white hover:text-sunuOrange flex items-center justify-center transition-all duration-300"
                  aria-label="Facebook"
                >
          ...
          <div className="grain-texture bg-gradient-to-br from-sunuBlue via-sunuCyan to-sunuBlue rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl" data-aos="fade-left">
            <h3 className="text-2xl sm:text-3xl font-black mb-6 md:mb-8 text-white">Envoyez-nous un message</h3>
            <form ref={formRef} onSubmit={sendEmail} className="space-y-4 md:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <Input
                    name="prenom"
                    placeholder="Prénom*"
                    className="bg-white/10 border-white/30 text-white placeholder:text-white/70 focus:bg-white/20 h-11 sm:h-12"
                    required
                  />
                </div>
                <div>
              ...
              <Button
                type="submit"
                className="w-full bg-white text-sunuBlue hover:bg-sunuOrange hover:text-white font-bold py-5 sm:py-6 text-base sm:text-lg rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl group"
              >
                Envoyer
